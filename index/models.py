...
class Song(models.Model):
    ...
    song_name = models.CharField('歌名', max_length=30)
    song_singer = models.CharField('歌手', max_length=30)
    song_time = models.CharField('时长', max_length=10)
    song_album = models.CharField('专辑', max_length=30)
...
class Dynamic(models.Model):
    ...
    dynamic_play = models.IntegerField('播放次数')
...
class Comment(models.Model):
    ...
    comment_date = models.CharField('日期', max_length=30)
    song = models.ForeignKey(Song, on_delete=models.CASCADE, verbose_name='歌名')
